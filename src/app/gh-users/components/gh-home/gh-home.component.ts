...
export class GhHomeComponent implements OnInit {
  ...
  showDialog(){
    let ref = this.dialog.open(GhDialogComponent, {height:"100%"}); //Criar variavel para receber o valor

    ref.componentInstance.username = this.usernameToFind.value // Atribuir a variável do input para o dialog
  }
